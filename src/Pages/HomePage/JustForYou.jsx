...
const JustForYou = () => {
    ...
    return (
        <div className='my-6 px-5'>
            ...
            <div className='grid md:grid-cols-4 lg:gird-cols-5 grid-cols-3'>
                {
forYou.map(data=><div  onClick={()=>document.getElementById(`my_modal_3`).showModal()} className='hover:shadow-2xl cursor-pointer' key={data._Id}>
...
<p className='my-2 text-[12px] md:text-[15px]'>Description: {data.Description}</p>
    </div>
    </div>
</div>)
                }
